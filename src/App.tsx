...
import dp from './assets/lam dev.png'
        ...
        <section className='section-home-intro'>
          ...
          <motion.div className="hero-parent"
            ...
            <motion.div style={{x: translateX3}}>
              <h1 className='heading-3'><span className='heading-accent'>. LamDev.</span>L2m<span className='heading-accent'>.Lam.</span></h1>
            </motion.div>
            <motion.div style={{x: translateX4}}>
              <h1 className='heading-4'><span className='heading-accent'>. LamDev.</span> D3v<span className='heading-accent'> LamDev.</span></h1>
            </motion.div>
            </div>
          </motion.div>
        </section>
              ...
              <motion.div className='about-hero'
                ...
                <div className='flex-mobile'>
                  ...
                  <div className='about-txt'>
                    <p>
                      I'm a passionate developer based in HoChiMinh, Vietnam.
                      <br />
                      <br />
        ...
        <section className='section-projects'>
          <div className="container">
            ...
            <div className='portfolio-box' onMouseLeave={() => setPortfolioImg('none')} onMouseMove={(event) => {
              ...
              <a href="https://github.com/l2md3v/AnalytiXpert" title='Github Repo' target='_blank' className="portfolio-block-1" onMouseEnter={() => setPortfolioImg("Admin")}>
          ...
          <motion.div className="hero-parent"
            ...
            <div className="headline-txt">
              ...
              <motion.div style={{x: translateX6}}>
                <h1 className='heading-6'><span className='heading-accent'>. L2mD3v.</span> greatness.<span className='heading-accent'> L2mD3v.</span></h1>
              </motion.div>
            </div>
          </motion.div>
